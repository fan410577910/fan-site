...
//http://www.cnblogs.com/lykbk/p/uioiuouioiuo789879789.html 
...
namespace FAN.MongoDB
{
    ...
    public partial class MongoDBHelper
    {
        ...
        public static bool Insert<T>(T entity)
        {
            ...
            return Insert(collectionName, entity);
        }
        /// <summary>
        /// 插入对象
        /// </summary>
        ...
        public static void InsertAll<T>(IEnumerable<object> entitys)
        {
            string collectionName = typeof(T).Name;
            InsertAll(collectionName, entitys);
        }
        /// <summary>
        /// 批量插入对象
        /// </summary>
