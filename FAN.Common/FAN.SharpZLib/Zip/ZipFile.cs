...
using FAN.SharpZLib.Encryption;
#endif

using FAN.SharpZLib.Core;
using FAN.SharpZLib.Checksums;
using FAN.SharpZLib.Zip.Compression.Streams;
using FAN.SharpZLib.Zip.Compression;

namespace FAN.SharpZLib.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="TLZ.SharpZLib.Zip.ZipException">
