...
namespace FAN.Helper
{
    ...
    {
        private const string FROM = "basic_noreply@tidebuy.com";  //发件人邮箱地址
        private const string USERNAME = "basic_noreply@tidebuy.com"; //固定
        private const string PASSWORD = "E^Lk%0^7nzVG"; //固定
        private const string SERVER = "mail.tidebuy.com";    //那个 smtp

        public static string SendMail(string to, string body, string subject)
        {
            return SendHtml(FROM, to, subject, body, SERVER, USERNAME, PASSWORD);
        }
