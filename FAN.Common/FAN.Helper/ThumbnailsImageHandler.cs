...
namespace FAN.Helper
{
    ...
    public class ThumbnailsImageHandler
    {
        ...
        /// </summary>
        /// <param name="fromFile">原图Stream对象</param>
        /// <param name="fileSavePath">打完水印后的图片存放地址</param>
        /// <param name="watermarkText">水印文字(为""表示不使用水印)</param>
        /// <param name="watermarkImage">水印图片路径(为""表示不使用水印)</param>
        /// <param name="quality">质量（范围0-100）</param>
        public static void WaterMark(System.IO.FileStream fromFile, string fileSavePath, string watermarkText, string watermarkImage, int quality)
        {
            string dir = IOHelper.GetDirectoryName(fileSavePath);
            IOHelper.CreateDirectory(dir);
            IOHelper.DeleteFile(fileSavePath);
            ...
            using (System.Drawing.Image initImage = System.Drawing.Image.FromStream(fromFile, true))
            {
                WaterMark(initImage, fileSavePath, watermarkText, watermarkImage, quality, ici, ep);
            }
        }
        /// <summary>
        /// 图片打水印
        /// </summary>
        /// <param name="initImage">源图片对象</param>
        /// <param name="fileSavePath">打完水印后的图片存放地址</param>
        /// <param name="watermarkText">水印文字(为""表示不使用水印)</param>
        /// <param name="watermarkImage">水印图片路径(为""表示不使用水印)</param>
        /// <param name="quality">质量（范围0-100）</param>
        /// <param name="ici"></param>
        /// <param name="ep"></param>
        public static void WaterMark(System.Drawing.Image initImage, string fileSavePath, string watermarkText, string watermarkImage, int quality, ImageCodecInfo ici, EncoderParameters ep)
        {
            //文字水印
            if (!string.IsNullOrEmpty(watermarkText))
            {
        ...
        /// <param name="fileSavePath">打完水印后的图片存放地址</param>
        /// <param name="watermarkText">水印文字(为""表示不使用水印)</param>
        /// <param name="watermarkImage">水印图片对象(为null表示不使用水印)</param>
        /// <param name="quality">质量（范围0-100）</param>
        public static void WaterMark(System.IO.FileStream fromFile, string fileSavePath, string watermarkText, System.Drawing.Image watermarkImage, int quality)
        {
            string dir = IOHelper.GetDirectoryName(fileSavePath);
            IOHelper.CreateDirectory(dir);
            IOHelper.DeleteFile(fileSavePath);
        ...
        /// <param name="ici"></param>
        /// <param name="ep"></param>
        public static void WaterMark(System.Drawing.Image initImage, string fileSavePath, string watermarkText, System.Drawing.Image watermarkImage, int quality, ImageCodecInfo ici, EncoderParameters ep)
        {
            //文字水印
            if (!string.IsNullOrEmpty(watermarkText))
            {
            ...
            {
                //水印绘制条件：原始图片宽高均大于或等于水印图片
                if (initImage.Width >= watermarkImage.Width && initImage.Height >= watermarkImage.Height)
                {
                    Graphics gWater = Graphics.FromImage(initImage);
                    ...
                    ColorMatrix wmColorMatrix = new ColorMatrix(colorMatrixElements);
                    imgAttributes.SetColorMatrix(wmColorMatrix, ColorMatrixFlag.Default, ColorAdjustType.Bitmap);
                    gWater.DrawImage(watermarkImage, new Rectangle(initImage.Width - watermarkImage.Width, initImage.Height - watermarkImage.Height, watermarkImage.Width, watermarkImage.Height), 0, 0, watermarkImage.Width, watermarkImage.Height, GraphicsUnit.Pixel, imgAttributes);
        ...
        /// <param name="ici"></param>
        /// <param name="ep"></param>
        /// <returns>打完水印后的图片</returns>
        public static Image WaterMark(System.Drawing.Image initImage, string watermarkText, string watermarkImage, int quality, ImageCodecInfo ici, EncoderParameters ep)
        {
            Image resultImage = null;
        ...
        /// <param name="quality">质量（范围0-100）</param>
        /// <returns>打完水印后的图片</returns>
        public static Image WaterMark(System.IO.FileStream fromFile, string watermarkText, string watermarkImage, int quality)
        {
            Image resultImage = null;
            ImageCodecInfo ici = null;
            EncoderParameters ep = null;
            ...
            using (System.Drawing.Image initImage = System.Drawing.Image.FromStream(fromFile, true))
            {
                resultImage = WaterMark(initImage, watermarkText, watermarkImage, quality, ici, ep);
            }
            return resultImage;
        }
        /// <summary>
        ...
        /// <param name="ep"></param>
        /// <returns>打完水印后的图片</returns>
        public static Image WaterMark(System.Drawing.Image initImage, string watermarkText, System.Drawing.Image watermarkImage, int quality, ImageCodecInfo ici, EncoderParameters ep)
        {
            Image resultImage = null;
        ...
        /// <param name="quality">质量（范围0-100）</param>
        /// <returns>打完水印后的图片</returns>
        public static Image WaterMark(System.IO.FileStream fromFile, string watermarkText, System.Drawing.Image watermarkImage, int quality)
        {
            Image resultImage = null;
            ImageCodecInfo ici = null;
            EncoderParameters ep = null;
        ...
        public static void ImageEnoders(System.IO.FileStream fromFile, int quality, out ImageCodecInfo ici, out EncoderParameters ep)
        {
            ...
            //http://stackoverflow.com/questions/2267717/save-jpg-in-progressive-format
            //设置渐进式图片,不被支持
