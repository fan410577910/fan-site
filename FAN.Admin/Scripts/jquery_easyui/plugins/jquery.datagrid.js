...
(function ($) {
    ...
    function _56(_57) {
        ...
        if (_59.pagination) {
            ...
            _60.pagination({
                total: 0, pageNumber: _59.pageNumber, pageSize: _59.pageSize, pageList: _59.pageList, onSelectPage: function (_62, _63) {
                    _59.pageNumber = _62;
                    _59.pageSize = _63;
    ...
    function _6e(_6f) {
        ...
        _74.each(function () {
            $(this).resizable({
                handles: _7a, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _70.resizing = true;
    ...
    var _1de = {
        render: function (_1df, _1e0, _1e1) {
            ...
            //$(_1e0).html(_1e4.join(""));//杨焕文注释，替换成下面语句，提升列表页面渲染速度2016-4-5 13:38:38
