...
(function ($) {
    ...
    function _2b(_2c, pp, _2d) {
        ...
        _2d = _2d || {};
        pp.panel($.extend({}, _2d, {
            border: false, noheader: true, closed: true, doSize: false, iconCls: (_2d.icon ? _2d.icon : undefined), onLoad: function () {
                if (_2d.onLoad) {
    ...
    function _37(_58, _59) {
        ...
        var _5e = _1c(_58);
        if (_5e) {
            if (_5d[0] == _5e[0]) { return }
            unselectTab(_58, _31(_58, _5e));
            //if (!_5e.panel('options').closed) { return }
            //_5e.panel("close");
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, plain: false, fit: false, border: true, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_77) {
        }, onSelect: function (_314, _315) {
        }, onUnselect: function (_314, _315) {
