...
(function ($) {
    ...
    function _13c(_13d, _13e) {
        _13e = _13e || "checked";
        if (typeof (_13e) === "string") _13e = [_13e + ""];
        var _13f = "", item = "";
...
(function ($) {
    ...
    function _2e1(_2fb, _2fc) {
        ...
        var _2ff = _2ce(_2fb);
        if (_2ff) {
            if (_2fe[0] == _2ff[0]) { return }
            unselectTab(_2fb, _2dd(_2fb, _2ff));
            if (!_2ff.panel('options').closed) { return }
            //_2ff.panel("close");
        ...
        if (p) {
            ...
            if (!opts.closed) {
                ...
                if (opts.closed) {
                    ...
                    state.options.onUnselect.call(container, opts.title, which);
                }
            }
        }
    };
